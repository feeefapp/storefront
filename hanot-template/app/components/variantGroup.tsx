...
export function VariantButton({
  ...
  const child = (
    <div
      className={
        "cursor-pointer flex justify-center items-center border-transparent overflow-hidden shadow-xl border-2 min-w-14 px-2 h-8 rounded-full  bg-opacity-5  focus:bg-opacity-100"
      }
    >
      {variant.name}
    </div>
  ...
  return (
    <div
      ...
      className={
        (selected
          ? "border-primary"
          : " dark:border-white border-black border-opacity-20") +
        " rounded-full p-[2px] border-2 mx-1 my-1 flex justify-center items-center"
      }
    >
      {child}
    </div>
    ...
    <div
      ...
      className={
        (selected
          ? "border-primary   "
          : " dark:border-white border-black border-opacity-20") +
        " rounded-[17px] border-2 mx-1 my-1 flex justify-center items-center"
      }
    >
      {child}
    </div>
...
function RenderVariantGroup({
  ...
  return (
    <div>
      ...
      {selected && getVariant(selected)?.child && (
        <RenderVariantGroup
